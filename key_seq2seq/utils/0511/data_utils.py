...
def sentence_to_token_ids(sentence, vocabulary,
  ...
  source_list=[]
  dis_list=[]
  source_list.extend(pairs[0].strip())
  dis_list.extend(pairs[1].strip())
...
def prepare_chitchat_data(data_dir, vocabulary, vocabulary_size, tokenizer=None):
  ...
  train_ids_path = data_dir + ("/ids%d.train" % vocabulary_size)
  ...
  data_to_token_ids(data_dir+ "/data.train", train_ids_path,  vocabulary, tokenizer)

  # Create token ids for the development data.
  dev_ids_path = data_dir + ("/ids%d.valid" % vocabulary_size)
  #query_dev_ids_path = data_dir + (".ids%d.query" % vocabulary_size)
  data_to_token_ids(data_dir + "/data.valid", dev_ids_path, vocabulary, tokenizer)
